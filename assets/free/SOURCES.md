...
All raster and audio assets in this folder are free assets used for this prototype.

- `snake-glow.png`, `energy-bloom.png`, `venom-mist.png`, `spark.png`, `slash.png`: Kenney Particle Pack, Creative Commons CC0.
- `ui-panel.png`: Kenney UI Pack - Sci-Fi, Creative Commons CC0.
- `grid-line.png`: Kenney Top-down Shooter, Creative Commons CC0.
